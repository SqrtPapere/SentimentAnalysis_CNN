...
from keras.layers import Embedding, Conv1D, MaxPooling1D, Flatten, Dense, Input, GlobalMaxPooling1D, Dropout, Merge, concatenate, LSTM
...
tensorboard = TensorBoard(log_dir='./GraphDOB', histogram_freq=0, write_graph=True)
